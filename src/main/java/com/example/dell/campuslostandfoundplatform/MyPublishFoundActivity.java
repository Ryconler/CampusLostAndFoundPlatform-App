...
public class MyPublishFoundActivity extends AppCompatActivity {
    ...
    private void initListView(){
        ...
        AdapterView.OnItemClickListener listener=new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent=new Intent(MyPublishFoundActivity.this,ArticleDetailActivity.class);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    arrayAdapter=new ArticleListAdapter(MyPublishFoundActivity.this,R.layout.article_list_item, articleListList);
                    UpdateGUI();
                }
            }
        }).start();
